...
## TEST BRANCH: Sandbox for Node File Uploads Using Streams - 24 December 2016 ##

- This branch is based on v2.0.4. Tag [2.0.4](https://github.com/TTLabs/EvaporateJS/tree/2.0.4) represents enhancements
to the main codebase plus refactoring to simplify adding support for streams.
- Tag [2.0.4-electron.4](https://github.com/TTLabs/EvaporateJS/tree/2.0.4-electron.4) includes the first proof of concept
enhancements.
- Branch [electron](https://github.com/TTLabs/EvaporateJS/tree/electron) includes a build of electron's sandbox that is
hooked up to `2.0.4-electron.4`.
